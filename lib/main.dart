...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Amortizador(),
    );
  }
}

class Amortizador extends StatefulWidget {
  const Amortizador({super.key});

  @override
  State<Amortizador> createState() => _AmortizadorState();
}

class _AmortizadorState extends State<Amortizador> {
